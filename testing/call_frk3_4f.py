...
observer = cocoex.Observer("bbob", "result_folder: " + "FRK34f_all")

nfe = 1e+6
repetitions = 10

solver_list = iter([frk3_4f01]*15 + [frk3_4f06]*15 + [frk3_4f15]*15 + [frk3_4f21]*15)
# solver_list = iter([frk3_4f01]*1 + [frk3_4f06]*1 + [frk3_4f15]*1 + [frk3_4f21]*1)
