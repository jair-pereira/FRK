...
suite = cocoex.Suite("bbob", "", "function_indices:15 dimensions:10 instance_indices:1-15")
observer = cocoex.Observer("bbob", "result_folder: " + "frk22f_15")
...
for problem in suite:
    ...
    for i in range(repetitions):
        if not problem.final_target_hit:
            ...
            fw = open("frk2_4f15_"+str(problem.id)+"_r"+str(i)+".pkl", "wb")
            pickle.dump(S, fw)
            fw.close()
