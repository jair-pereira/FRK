...
observer = cocoex.Observer("bbob", "result_folder: " + "FRK11f_tr")
...
solver_list = iter([frk1_1f01]*15 + [frk1_1f06]*15 + [frk1_1f15]*15 + [frk1_1f21]*15)
solver_list = iter([frk1_1f01]*1 + [frk1_1f06]*1 + [frk1_1f15]*1 + [frk1_1f21]*1)
