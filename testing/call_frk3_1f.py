...
observer = cocoex.Observer("bbob", "result_folder: " + "FRK31f_all")

nfe = 1e+6
repetitions = 10

solver_list = iter([frk3_1f01]*15 + [frk3_1f06]*15 + [frk3_1f15]*15 + [frk3_1f21]*15)
# solver_list = iter([frk3_1f01]*1 + [frk3_1f06]*1 + [frk3_1f15]*1 + [frk3_1f21]*1)
