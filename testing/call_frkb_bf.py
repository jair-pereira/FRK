...
observer = cocoex.Observer("bbob", "result_folder: " + "frkbbf_all")

nfe = 1e+6
repetitions = 10

solver_list = iter([frkb_bf01]*15 + [frkb_bf06]*15 + [frkb_bf15]*15 + [frkb_bf21]*15)
# solver_list = iter([frkb_bf01]*1 + [frkb_bf06]*1 + [frkb_bf15]*1 + [frkb_bf21]*1)
