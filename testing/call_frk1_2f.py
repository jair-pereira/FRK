...
observer = cocoex.Observer("bbob", "result_folder: " + "FRK12f_all")

nfe = 1e+6
repetitions = 10

solver_list = iter([frk1_2f01]*15 + [frk1_2f06]*15 + [frk1_2f15]*15 + [frk1_2f21]*15)
# solver_list = iter([frk1_2f01]*1 + [frk1_2f06]*1 + [frk1_2f15]*1 + [frk1_2f21]*1)
