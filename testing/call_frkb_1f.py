...
observer = cocoex.Observer("bbob", "result_folder: " + "frkb1f_all")
...
solver_list = iter([frkb_1f01]*15 + [frkb_1f06]*15 + [frkb_1f15]*15 + [frkb_1f21]*15)
# solver_list = iter([frkb_1f01]*1 + [frkb_1f06]*1 + [frkb_1f15]*1 + [frkb_1f21]*1)
